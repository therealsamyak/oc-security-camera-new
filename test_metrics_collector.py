...
class TestCSVExporter(unittest.TestCase):
    ...
    def test_empty_simulation_handling(self):
        ...
        summary_file = self.exporter.export_summary(empty_metrics, self.sample_simulation_info)
        timeseries_file = self.exporter.export_detailed_timeseries(empty_metrics, self.sample_simulation_info)
