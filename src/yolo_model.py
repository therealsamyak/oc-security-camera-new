...
class YOLOModel:
    ...
    def _load_model_specs(self) -> Dict[str, float]:
        ...
        try:
            ...
            model_row = df[(df['model'] == self.model_name) & 
                          (df['version'] == self.model_version)]
    ...
    def benchmark_power_consumption(self, image_path: str, iterations: int = 10) -> float:
        """
        ...
        self.logger.info(f"Power benchmark for {self.model_name} v{self.model_version}: {estimated_power_mw:.2f} mW")
